...
export const greetings = {
	...
	title: "Hi there!",
	desc: [
		("I'm Alborz, but I also go by Al. I'm a full-stack software developer based in Winnipeg, Canada with 2 years of experience building both enterprise + startup software. I'm business-minded with a background in Product and an eye for design."),
		"I'm always open to offers for full-time work or contract web development. Please continue reading to learn more about me.",
	],
};
...
export const socialLinks = {
	...
	email: "mailto:akhakbazan0@gmail.com",
...
export const aboutSection = {
	...
	desc: [
			...
			" I'm incredibly passionate about my values and I love working on projects that push boundaries.",
	],		
}
...
// 				{ skillName: "CSS", fontAwesomeClassname: "vscode-icons:file-type-css", },
...
// 				{ skillName: "Postgres", fontAwesomeClassname: "logos:postgresql", },	
...
export const skillsSection = {
  ...
  data: [
    {
      title: "Core",
      lottieAnimationFile: "/lottie/skills/software.json",
      skills: [
        " ▪️ Full-stack development with modern web frameworks and RESTful APIs",
        " ▪️ Object-oriented programming, data structures, and algorithm optimization",
        " ▪️ Software architecture, SOLID principles, and system design",
      ],
      softwareSkills: [
        { skillName: "TypeScript", fontAwesomeClassname: "logos:typescript-icon" },
        { skillName: "JavaScript", fontAwesomeClassname: "logos:javascript" },
    ...
    {
      title: "Frontend & UI",
      lottieAnimationFile: "/lottie/skills/webdev.json",
      skills: [
        " ▪️ Responsive web design with modern component libraries",
        " ▪️ UI/UX design and wireframing with Figma",
        " ▪️ Performance optimization and E2E testing for web applications",
      ],
      softwareSkills: [
        { skillName: "React", fontAwesomeClassname: "logos:react" },
        { skillName: "Redux", fontAwesomeClassname: "logos:redux" },
        ...
        { skillName: "Tailwind", fontAwesomeClassname: "logos:tailwindcss-icon" },
        // { skillName: "Figma", fontAwesomeClassname: "logos:figma" },
		{ skillName: "Jest", fontAwesomeClassname: "logos:jest" },
		{ skillName: "Playwright", fontAwesomeClassname: "logos:playwright" },
      ],
    },
    {
      ...
      lottieAnimationFile: "/lottie/skills/systems.json",
      skills: [
        " ▪️ API development (REST/GraphQL), database design, and system architecture",
        " ▪️ Cloud services, microservices, and serverless functions",
        " ▪️ IoT development, hardware integration, and real-time data processing",
      ],
      softwareSkills: [
        { skillName: "Node", fontAwesomeClassname: "logos:nodejs-icon" },
        // { skillName: "NET Core", fontAwesomeClassname: "vscode-icons:file-type-dotnetcore" },
		// { skillName: "AWS", fontAwesomeClassname: "logos:net" },
        { skillName: "AWS", fontAwesomeClassname: "logos:aws" },
		{ skillName: "GraphQL", fontAwesomeClassname: "logos:graphql" },
		{ skillName: "SQL", fontAwesomeClassname: "vscode-icons:file-type-sql" },
        { skillName: "Postgres", fontAwesomeClassname: "logos:postgresql" },
        { skillName: "Docker", fontAwesomeClassname: "logos:docker-icon" },
        // { skillName: "Neo4J", fontAwesomeClassname: "simple-icons:neo4j" },
    ...
    },
    {
      ...
      lottieAnimationFile: "/lottie/skills/product.json",
      skills: [
        " ▪️ Product strategy, roadmapping, and feature prioritization",
        " ▪️ Agile/scrum development and sprint planning",
        " ▪️ User research, A/B testing, and data-driven decision making",
      ],
      softwareSkills: [
        { skillName: "Jira", fontAwesomeClassname: "logos:jira" },
        { skillName: "Confluence", fontAwesomeClassname: "logos:confluence" },
...
export const educationInfo = [
	{
		...
		subHeader: "BSc., Computer Science (Co-Op)",
		duration: "Fall 2024",
...
export const workSection = {
	...
	resumeLink:
		...
		"https://drive.google.com/file/d/1-eu0OJsAwgJeYLhTNJ9q0xzZZf9TTfjX/view?usp=sharing_s",
	linkedIn:
	...
	data: [
		{
		company: "Laivly",
		companyWebsite: "https://laivly.com", 
		lottieAnimationFile: "/lottie/career/laivly.json", // You'll need to create this animation file
		positions: [
			{
			title: "Software Developer, Aperture",
			duration: "May 2024 - February 2025",
			responsibilities: [
				("After graduation, I joined Laivly as a full-time developer where I worked on building AI-powered CX products for Fortune 100 clients. My main focus was on their SIDD Studio platform, where I led the front-end development for the SIDD Spark Drivers & Dispositions and Case Notes features that are now used by tens of thousands of users."),
				("I worked full stack with technologies like Vue, C#, and .NET Core, building everything from reusable front-end components to API endpoints and database migrations."),
				("Some other notable features I worked on include an audit log system with version-control, a complex CSV upload & review process, and optimizing user lookups via debouncing and localforage.")
			],
			},
		],
		},
		{
			company: "QDoc",
			companyWebsite: "https://qdoc.ca",
			// companylogo: "img/icons/common/qdoc.jpg",	
			lottieAnimationFile: "/lottie/career/qdoc.json",
			positions: [
			{
				title: "Software Developer, Core",
				duration: "September 2023 - December 2023",
				responsibilities: [
					("My second co-op work term at the MedicalTech startup QDoc was a huge opportunity for me not just to continue growing my skills as a developer, but also to apply the skills I developed in my first term."),
					...
					("I also worked on a number of other features for QDoc's web apps using JavaScript, React, Redux, and AWS (Lambda, CloudWatch, etc.)"),
				],	
			},	
			],
		},	
			...
			positions: [
					{
						...
						responsibilities: [
							("After my co-op term at the PropTech startup Gryd ended, I was offered to stay on for the summer and fill a new role to help continue developing some of the products I worked on as well as contribute full-stack code to some new ones. I mainly worked with TypeScript, React, and C++."),
					...
					},	
					{
						...
						responsibilities: [
							("My first co-op work term at the PropTech startup Gryd was a huge learning experience. I led the work on some major projects for their GrydPark division that you'll hopefully see launched soon."),
...
export const projects = [
		...
		tools: [
				...
				{ toolName: "AWS", toolIcon: "bxl:aws", },											
				{ toolName: "Docker", toolIcon: "bxl-docker", },	
				{ toolName: "Git", toolIcon: "bxl:git", },							
				// { toolName: "Vercel", toolIcon: "ion:logo-vercel", },																		
			],				
		desc: "A web app for connecting local communities.",
		github: "https://github.com/br-cz/neighbourhood",
	...
	},			
	{
		...
		desc: "A social web app for movie nights & watchlists with friends.",
	...
	},		
	{
		...
		desc: "This is the website you're currently viewing!",
...
export const recommendations = [
	{ name: "VSCode", subtitle: "Code Editor", logo: "img/icons/common/recommendations/vscode.png", link: "https://code.visualstudio.com/"},
	{ name: "Claude", subtitle: "AI Assistant", logo: "img/icons/common/recommendations/claude.png", link: "https://claude.ai/"},
	{ name: "Edison Mail", subtitle: "Communication", logo: "img/icons/common/recommendations/edison.png", link: "https://www.edisonmail.com/"},	
	{ name: "Notion", subtitle: "Documentation", logo: "img/icons/common/recommendations/notion.png", link: "https://www.notion.com/"},
	...
	{ name: "One Dark Pro", subtitle: "Editor Theme", logo: "img/icons/common/recommendations/odp.png", link: "https://marketplace.visualstudio.com/items?itemName=zhuangtongfa.Material-theme"},
	...
	{ name: "Squoosh", subtitle: "Image Compression", logo: "img/icons/common/recommendations/squoosh.jpg", link: "https://squoosh.app/" },	
	{ name: "Brave", subtitle: "Web Browser", logo: "img/icons/common/recommendations/brave.png", link: "https://brave.com/" },
